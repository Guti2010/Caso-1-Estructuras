...
public:
    vector<News *> getRecords(string pKeyWord)
    {
        ...
        string url = "https://newsapi.org/v2/everything?q="+pKeyWord+"&from=2023-09-03&sortBy=popularity&apiKey=e75d9b1446ce4c88b215b389f486f867";
